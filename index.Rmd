...
<p style="font-size:130%;">`r load('common/course_info.RData'); lstCI$course`</p>
...
* [Workshop Etherpad](https://public.etherpad-mozilla.org/p/rspatial-baygeo-f18){target="_blank"}
